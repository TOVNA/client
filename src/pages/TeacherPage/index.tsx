...
const TeacherPage: React.FC = () => {
  ...
  if (teacherError) {
    return <FullScreenMessage title='קרתה בעיה בטעינת פרטי המורה, אנא נסה שוב מאוחר יותר.' />;
  }
  ...
  return (
    <div>
      ...
      <Card>
        ...
        {questionnairesError ? (
          <FullScreenMessage title='קרתה בעיה בטעינת השאלונים, אנא נסה שוב מאוחר יותר.' />
        ) : (
          <AgGridReact
            loading={loading}
      ...
      <Card>
        ...
        {classesError || classSubjectsError ? (
          <FullScreenMessage title='קרתה בעיה בטעינת הכיתות, אנא נסה שוב מאוחר יותר.' />
        ) : (
          <AgGridReact
            loading={loading}
            loadingOverlayComponent={LoadingSpinner}
